...
def euler_verfahren():
    ...
    plt.plot(np.linspace(0,goal_number,number_of_iterations+1),res_list,label="euler_verfahren")
...
def zwei_schritt_Adams_Bashforth_verfahren():
    ...
    plt.plot(np.linspace(0,goal_number,number_of_iterations+1),res_list,label="zwei_schritt_Adams_Bashforth_verfahren")
